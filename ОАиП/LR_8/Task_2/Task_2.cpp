...
int main() {
    ...
    do {
        ...
        std::cout << "8. Сортировать для общежития (доход < 2*MIN_WAGE(Минимальная зарплата в белорусских рублях равна 626 рублей), затем по убыванию балла)\n";
        ...
        switch (choice) {
            ...
            case 3:
                if (!students) {
                    ...
                    students = addElements(students, size);
                }
                break;
            case 4:
                if (!students) {
            ...
            case 5:
                if (!students) {
                    ...
                    students = deleteElement(students, size);
                }
                break;
            case 6:
                if (!students) {
            ...
            case 9:
                ...
                break;
            case 10:
                loadFromFile(students, size, "students.txt");
                break;
            case 0:
