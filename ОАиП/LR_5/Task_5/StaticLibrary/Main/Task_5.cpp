...
void displayContextMenu() {
    std::cout << "Лабораторная работа №5, задание №5\n";
...
void inputDimensions(ll& lines, ll& columns) {
    std::cout << "Введите количество строк двумерного массива lines (целое число):\n";
    while (true) {
    ...
    std::cout << "Введите количество столбцов двумерного массива columns (целое число):\n";
    while (true) {
...
int main() {
    ...
    while (true) {
        ...
        double average = calculateAverage(final_array, final_array_size);
        std::cout << "Среднее арифметическое элементов динамического массива равно "
